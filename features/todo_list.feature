Feature: To-Do List Management
  ...
  Scenario: Update a task
    Given the todo list contains
      ...
      | Buy groceries | Buy milk, eggs, bread, cereal  | False  |
      | Do laundry    | Wash clothes and dry them      | False  |
    When the user updates the task 1 to "Buy groceries and fruits" "Buy milk, eggs, bread, cereal and fruits"
    Then the to-do list should contain
      | Name                  | Description                    | Status |
      | Buy groceries and fruits | Buy milk, eggs, bread, cereal and fruits  | False  |
      | Do laundry            | Wash clothes and dry them      | False  |
  ...
  Scenario: Mark a task as undone
    Given the todo list contains
      ...
      | Buy groceries | Buy milk, eggs, bread, cereal  | True   |
      | Do laundry    | Wash clothes and dry them      | False  |
    When the user marks the task 1 as undone
    Then the to-do list should contain
      | Name          | Description                    | Status |
      | Buy groceries | Buy milk, eggs, bread, cereal  | False  |
      | Do laundry    | Wash clothes and dry them      | False  |